...
| ------- | ---- | ------------- | ---------------- | ---- | ----------- | -------------- |
| 1 | s1-leaf1 | NTP | Synchronised with NTP server | NTP | FAIL | The device is not synchronized with the configured NTP server(s): 'NTP is disabled.' |
| 8 | s1-leaf1 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel4 - s1-host1_PortChannel | FAIL | The following interface(s) are not in the expected state: ['Port-Channel4 is lowerLayerDown/down expected up/up'] |
...
| 96 | s1-leaf3 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel4 - s1-host2_PortChannel | FAIL | The following interface(s) are not in the expected state: ['Port-Channel4 is lowerLayerDown/down expected up/up'] |
| 133 | s1-leaf4 | NTP | Synchronised with NTP server | NTP | FAIL | The device is not synchronized with the configured NTP server(s): 'NTP is disabled.' |
...
| ------- | ---- | ------------- | ---------------- | ---- | ----------- | -------------- |
| 1 | s1-leaf1 | NTP | Synchronised with NTP server | NTP | FAIL | The device is not synchronized with the configured NTP server(s): 'NTP is disabled.' |
| 2 | s1-leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet1 - MLAG_PEER_s1-leaf2_Ethernet1 | PASS | - |
| 3 | s1-leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet6 - MLAG_PEER_s1-leaf2_Ethernet6 | PASS | - |
| 4 | s1-leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet2 - P2P_LINK_TO_S1-SPINE1_Ethernet2 | PASS | - |
| 5 | s1-leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet3 - P2P_LINK_TO_S1-SPINE2_Ethernet2 | PASS | - |
| 6 | s1-leaf1 | Interface State | Ethernet Interface & Line Protocol == "up" | Ethernet4 - s1-host1_Ethernet1 | PASS | - |
| 7 | s1-leaf1 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel1 - MLAG_PEER_s1-leaf2_Po1 | PASS | - |
| 8 | s1-leaf1 | Interface State | Port-Channel Interface & Line Protocol == "up" | Port-Channel4 - s1-host1_PortChannel | FAIL | The following interface(s) are not in the expected state: ['Port-Channel4 is lowerLayerDown/down expected up/up'] |
| 9 | s1-leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | PASS | - |
| 10 | s1-leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan4094 - MLAG_PEER | PASS | - |
| 11 | s1-leaf1 | Interface State | Vlan Interface & Line Protocol == "adminDown" | Vlan110 - Tenant_A_OP_Zone_1 | PASS | - |
| 12 | s1-leaf1 | Interface State | Vlan Interface & Line Protocol == "up" | Vlan3009 - MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | PASS | - |
| 13 | s1-leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback0 - EVPN_Overlay_Peering | PASS | - |
| 14 | s1-leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback1 - VTEP_VXLAN_Tunnel_Source | PASS | - |
| 15 | s1-leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback100 - Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | PASS | - |
| 16 | s1-leaf1 | Interface State | Vxlan Interface Status & Line Protocol == "up" | Vxlan1 | PASS | - |
| 17 | s1-leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet1 - remote: s1-leaf2_Ethernet1 | PASS | - |
| 18 | s1-leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet6 - remote: s1-leaf2_Ethernet6 | PASS | - |
| 19 | s1-leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet2 - remote: s1-spine1_Ethernet2 | PASS | - |
| 20 | s1-leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: s1-spine2_Ethernet2 | PASS | - |
| 21 | s1-leaf1 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet4 - remote: s1-host1_Ethernet1 | PASS | - |
| 22 | s1-leaf1 | IP Reachability | ip reachability test p2p links | Source: s1-leaf1_Ethernet2 - Destination: s1-spine1_Ethernet2 | PASS | - |
...
| 59 | s1-leaf2 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback100 - Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | PASS | - |
...
| 170 | s1-leaf4 | Routing Table | Remote Lo0 address | 192.0.255.2 | PASS | - |
...
| 207 | s1-spine2 | LLDP Topology | LLDP topology - validate peer and interface | local: Ethernet3 - remote: s1-leaf2_Ethernet3 | PASS | - |
